...
describe('tracer should', function () {
  ...
  it('create a span correctly through _startInternalSpan', function () {
    ...
    var references = [];
    var span = tracer._startInternalSpan(context, 'op-name', start, tags, internalTags, references, false, rpcServer);
    ...
    _chai.assert.isTrue(_test_util2.default.hasTags(span, {
      keyOne: 'Leela',
      keyTwo: 'Bender',
      'sampler.type': 'const',
      'sampler.param': true,
  ...
  it('inject plain text headers into carrier, and extract span context with the same value 128bits', function () {
    ...
    var savedContext = _span_context2.default.withBinaryIds(Buffer.concat([_util2.default.encodeInt64(1), _util2.default.encodeInt64(2)]), _util2.default.encodeInt64(2), _util2.default.encodeInt64(3), constants.SAMPLED_MASK, baggage);
  ...
  it('start a root span with 128 bit traceId', function () {
    tracer = new _tracer2.default('test-service-name', reporter, new _const_sampler2.default(true), { traceId128bit: true });
    var span = tracer.startSpan('test-name');
...
it('should match parent and spanIds when in rpc server mode', function () {
  ...
  var customTracer = new _tracer2.default('test-service-name', customReporter, new _const_sampler2.default(true), {
    shareRpcSpan: true
  });
