...
describe('All samplers', function () {
  describe('should support close()', function () {
    var samplers = (0, _combinations2.default)({
      ...
      sampler: [new _const_sampler2.default(true), new _const_sampler2.default(false), new _probabilistic_sampler2.default(0.5), new _rate_limiting_sampler2.default(2), new _guaranteed_throughput_sampler2.default(2, 0.5), new _per_operation_sampler2.default({
